...
var cb_success = ((function (ret_chan,temp_list,trans,store,date_index,cursor,map__11301,map__11301__$1,feeduid_list){
return (function (e){
...
var feeduid_11302 = (res.value["feeduid"]);
if(cljs.core.truth_(cljs.core.some.call(null,((function (feeduid_11302,res,ret_chan,temp_list,trans,store,date_index,cursor,map__11301,map__11301__$1,feeduid_list){
return (function (p1__11298_SHARP_){
return cljs.core._EQ_.call(null,feeduid_11302,p1__11298_SHARP_);
});})(feeduid_11302,res,ret_chan,temp_list,trans,store,date_index,cursor,map__11301,map__11301__$1,feeduid_list))
,feeduid_list))){
cljs.core.swap_BANG_.call(null,temp_list,cljs.core.conj,cljs.core.js__GT_clj.call(null,res.value,new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252),true));
} else {
}
...
});})(ret_chan,temp_list,trans,store,date_index,cursor,map__11301,map__11301__$1,feeduid_list))
;
