...
ghoul.http.send = (function send(p__22627){
var map__22630 = p__22627;
...
var response__GT_data = cljs.core.get.call(null,map__22630__$1,new cljs.core.Keyword(null,"response->data","response->data",52433877));
var data = cljs.core.get.call(null,map__22630__$1,new cljs.core.Keyword(null,"data","data",-232669377));
var url = cljs.core.get.call(null,map__22630__$1,new cljs.core.Keyword(null,"url","url",276297046));
var method = cljs.core.get.call(null,map__22630__$1,new cljs.core.Keyword(null,"method","method",55703592));
...
}catch (e22631){if((e22631 instanceof Error)){
var e_22632 = e22631;
cljs.core.async.put_BANG_.call(null,c,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"result","result",1415092211),new cljs.core.Keyword(null,"error","error",-978969032),new cljs.core.Keyword(null,"message","message",-406056002),[cljs.core.str(e_22632.message)].join('')], null));
} else {
throw e22631;

}
}
goog.events.listen(xhr,goog.net.EventType.SUCCESS,((function (c,xhr,method__$1,map__22630,map__22630__$1,response__GT_data,data,url,method){
return (function (e){
...
});})(c,xhr,method__$1,map__22630,map__22630__$1,response__GT_data,data,url,method))
);

goog.events.listen(xhr,goog.net.EventType.ERROR,((function (c,xhr,method__$1,map__22630,map__22630__$1,response__GT_data,data,url,method){
return (function (e){
