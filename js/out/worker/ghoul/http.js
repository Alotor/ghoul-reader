...
ghoul.http.headers = {};
ghoul.http.send = (function send(p__24517){
var map__24520 = p__24517;
...
var response__GT_data = cljs.core.get.call(null,map__24520__$1,new cljs.core.Keyword(null,"response->data","response->data",52433877));
var data = cljs.core.get.call(null,map__24520__$1,new cljs.core.Keyword(null,"data","data",-232669377));
var url = cljs.core.get.call(null,map__24520__$1,new cljs.core.Keyword(null,"url","url",276297046));
var method = cljs.core.get.call(null,map__24520__$1,new cljs.core.Keyword(null,"method","method",55703592));
...
var e_24522 = e24521;
cljs.core.async.put_BANG_.call(null,c,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"result","result",1415092211),new cljs.core.Keyword(null,"error","error",-978969032),new cljs.core.Keyword(null,"message","message",-406056002),[cljs.core.str(e_24522.message)].join('')], null));
} else {
throw e24521;

}
}
goog.events.listen(xhr,goog.net.EventType.SUCCESS,((function (c,xhr,method__$1,map__24520,map__24520__$1,response__GT_data,data,url,method){
return (function (e){
...
});})(c,xhr,method__$1,map__24520,map__24520__$1,response__GT_data,data,url,method))
);

goog.events.listen(xhr,goog.net.EventType.ERROR,((function (c,xhr,method__$1,map__24520,map__24520__$1,response__GT_data,data,url,method){
return (function (e){
