...
cljs_time.coerce.ICoerce = (function (){var obj22090 = {};
return obj22090;
})();
...
return cljs.core.first.call(null,(function (){var iter__4359__auto__ = (function iter__22101(s__22102){
return (new cljs.core.LazySeq(null,(function (){
var s__22102__$1 = s__22102;
while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__22102__$1);
if(temp__4126__auto__){
var s__22102__$2 = temp__4126__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__22102__$2)){
var c__4357__auto__ = cljs.core.chunk_first.call(null,s__22102__$2);
var size__4358__auto__ = cljs.core.count.call(null,c__4357__auto__);
var b__22104 = cljs.core.chunk_buffer.call(null,size__4358__auto__);
if((function (){var i__22103 = (0);
while(true){
if((i__22103 < size__4358__auto__)){
var f = cljs.core._nth.call(null,c__4357__auto__,i__22103);
var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e22107){if((e22107 instanceof Error)){
var _ = e22107;
return null;
} else {
throw e22107;
...
cljs.core.chunk_append.call(null,b__22104,d);

var G__22109 = (i__22103 + (1));
i__22103 = G__22109;
continue;
} else {
var G__22110 = (i__22103 + (1));
i__22103 = G__22110;
continue;
}
} else {
...
var f = cljs.core.first.call(null,s__22102__$2);
var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
...
if(cljs.core.truth_(d)){
return cljs.core.cons.call(null,d,iter__22101.call(null,cljs.core.rest.call(null,s__22102__$2)));
} else {
var G__22111 = cljs.core.rest.call(null,s__22102__$2);
s__22102__$1 = G__22111;
continue;
}
}
} else {
...
if(cljs.core.truth_(temp__4124__auto__)){
var dt = temp__4124__auto__;
var G__22113 = (new goog.date.Date());
G__22113.setYear(dt.getYear());

G__22113.setMonth(dt.getMonth());

G__22113.setDate(dt.getDate());
...
if(cljs.core.truth_(temp__4124__auto__)){
var dt = temp__4124__auto__;
var G__22115 = (new goog.date.DateTime());
G__22115.setYear(dt.getYear());

G__22115.setMonth(dt.getMonth());

G__22115.setDate(dt.getDate());

G__22115.setHours(dt.getHours());

G__22115.setMinutes(dt.getMinutes());

G__22115.setSeconds(dt.getSeconds());

G__22115.setMilliseconds(dt.getMilliseconds());
