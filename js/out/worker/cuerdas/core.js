...
var G__23189__delegate = function (s,tags){
...
var G__23189 = function (s,var_args){
var tags = null;
if (arguments.length > 1) {
  tags = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return G__23189__delegate.call(this,s,tags);};
G__23189.cljs$lang$maxFixedArity = 1;
G__23189.cljs$lang$applyTo = (function (arglist__23190){
var s = cljs.core.first(arglist__23190);
var tags = cljs.core.rest(arglist__23190);
return G__23189__delegate(s,tags);
});
...
format.cljs$lang$applyTo = (function (arglist__23191){
var s = cljs.core.first(arglist__23191);
var args = cljs.core.rest(arglist__23191);
...
var pad__delegate = function (s,p__23192){
var vec__23198 = p__23192;
var map__23199 = cljs.core.nth.call(null,vec__23198,(0),null);
var map__23199__$1 = ((cljs.core.seq_QMARK_.call(null,map__23199))?cljs.core.apply.call(null,cljs.core.hash_map,map__23199):map__23199);
var type = cljs.core.get.call(null,map__23199__$1,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"left","left",-399115937));
var padding = cljs.core.get.call(null,map__23199__$1,new cljs.core.Keyword(null,"padding","padding",1660304693)," ");
var length = cljs.core.get.call(null,map__23199__$1,new cljs.core.Keyword(null,"length","length",588987862),(0));
var padding__$1 = (padding[(0)]);
var padlen = (length - cljs.core.count.call(null,s));
var pred__23200 = cljs.core._EQ_;
var expr__23201 = type;
if(cljs.core.truth_(pred__23200.call(null,new cljs.core.Keyword(null,"right","right",-452581833),expr__23201))){
return [cljs.core.str(s),cljs.core.str(cuerdas.core.repeat.call(null,padding__$1,padlen))].join('');
} else {
if(cljs.core.truth_(pred__23200.call(null,new cljs.core.Keyword(null,"both","both",-393648840),expr__23201))){
...
if(cljs.core.truth_(pred__23200.call(null,new cljs.core.Keyword(null,"left","left",-399115937),expr__23201))){
return [cljs.core.str(cuerdas.core.repeat.call(null,padding__$1,padlen)),cljs.core.str(s)].join('');
} else {
throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__23201)].join('')));
}
}
}
};
...
return pad__delegate.call(this,s,p__23192);};
pad.cljs$lang$maxFixedArity = 1;
pad.cljs$lang$applyTo = (function (arglist__23203){
var s = cljs.core.first(arglist__23203);
var p__23192 = cljs.core.rest(arglist__23203);
return pad__delegate(s,p__23192);
});
