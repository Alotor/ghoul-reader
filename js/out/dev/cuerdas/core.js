...
var G__31521__delegate = function (s,tags){
...
var G__31521 = function (s,var_args){
var tags = null;
if (arguments.length > 1) {
  tags = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return G__31521__delegate.call(this,s,tags);};
G__31521.cljs$lang$maxFixedArity = 1;
G__31521.cljs$lang$applyTo = (function (arglist__31522){
var s = cljs.core.first(arglist__31522);
var tags = cljs.core.rest(arglist__31522);
return G__31521__delegate(s,tags);
});
...
format.cljs$lang$applyTo = (function (arglist__31523){
var s = cljs.core.first(arglist__31523);
var args = cljs.core.rest(arglist__31523);
...
var pad__delegate = function (s,p__31524){
var vec__31530 = p__31524;
var map__31531 = cljs.core.nth.call(null,vec__31530,(0),null);
...
var type = cljs.core.get.call(null,map__31531__$1,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"left","left",-399115937));
var padding = cljs.core.get.call(null,map__31531__$1,new cljs.core.Keyword(null,"padding","padding",1660304693)," ");
var length = cljs.core.get.call(null,map__31531__$1,new cljs.core.Keyword(null,"length","length",588987862),(0));
var padding__$1 = (padding[(0)]);
var padlen = (length - cljs.core.count.call(null,s));
var pred__31532 = cljs.core._EQ_;
var expr__31533 = type;
if(cljs.core.truth_(pred__31532.call(null,new cljs.core.Keyword(null,"right","right",-452581833),expr__31533))){
return [cljs.core.str(s),cljs.core.str(cuerdas.core.repeat.call(null,padding__$1,padlen))].join('');
} else {
if(cljs.core.truth_(pred__31532.call(null,new cljs.core.Keyword(null,"both","both",-393648840),expr__31533))){
...
if(cljs.core.truth_(pred__31532.call(null,new cljs.core.Keyword(null,"left","left",-399115937),expr__31533))){
return [cljs.core.str(cuerdas.core.repeat.call(null,padding__$1,padlen)),cljs.core.str(s)].join('');
} else {
throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__31533)].join('')));
}
}
}
};
...
var p__31524 = null;
if (arguments.length > 1) {
  p__31524 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return pad__delegate.call(this,s,p__31524);};
pad.cljs$lang$maxFixedArity = 1;
pad.cljs$lang$applyTo = (function (arglist__31535){
var s = cljs.core.first(arglist__31535);
var p__31524 = cljs.core.rest(arglist__31535);
return pad__delegate(s,p__31524);
});
...
//# sourceMappingURL=core.js.map?rel=1420049681107