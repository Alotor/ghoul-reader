...
if(typeof ghoul.app.components.popup.feed.t27189 !== 'undefined'){
} else {

/**
* @constructor
*/
ghoul.app.components.popup.feed.t27189 = (function (owner,data,root,meta27190){
this.owner = owner;
this.data = data;
this.root = root;
...
ghoul.app.components.popup.feed.t27189.prototype.om$core$IRender$ = true;

ghoul.app.components.popup.feed.t27189.prototype.om$core$IRender$render$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
...
ghoul.app.components.popup.feed.t27189.prototype.om$core$IDidUpdate$ = true;

ghoul.app.components.popup.feed.t27189.prototype.om$core$IDidUpdate$did_update$arity$3 = (function (this$,next_props,next_state){
var self__ = this;
var this$__$1 = this;
return om.core.get_node.call(null,self__.owner,"urlInput").value = "https://blog.taiga.io/feeds/rss.xml";
});

ghoul.app.components.popup.feed.t27189.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_27191){
var self__ = this;
var _27191__$1 = this;
return self__.meta27190;
});

ghoul.app.components.popup.feed.t27189.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_27191,meta27190__$1){
var self__ = this;
var _27191__$1 = this;
return (new ghoul.app.components.popup.feed.t27189(self__.owner,self__.data,self__.root,meta27190__$1));
});

ghoul.app.components.popup.feed.t27189.cljs$lang$type = true;

ghoul.app.components.popup.feed.t27189.cljs$lang$ctorStr = "ghoul.app.components.popup.feed/t27189";

ghoul.app.components.popup.feed.t27189.cljs$lang$ctorPrWriter = (function (this__4190__auto__,writer__4191__auto__,opt__4192__auto__){
return cljs.core._write.call(null,writer__4191__auto__,"ghoul.app.components.popup.feed/t27189");
});

ghoul.app.components.popup.feed.__GT_t27189 = (function __GT_t27189(owner__$1,data__$1,root__$1,meta27190){
return (new ghoul.app.components.popup.feed.t27189(owner__$1,data__$1,root__$1,meta27190));
});

}

return (new ghoul.app.components.popup.feed.t27189(owner,data,root,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"end-column","end-column",1425389514),63,new cljs.core.Keyword(null,"end-line","end-line",1837326455),39,new cljs.core.Keyword(null,"column","column",2078222095),3,new cljs.core.Keyword(null,"line","line",212345235),21,new cljs.core.Keyword(null,"file","file",-1269645878),"/home/alotor/Projects/GhoulReader/ghoul-reader/src/cljs/app/ghoul/app/components/popup/feed.cljs"], null)));
});

//# sourceMappingURL=feed.js.map?rel=1420049677174