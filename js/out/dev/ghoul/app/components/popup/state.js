...
var state_27250 = om.core.get_node.call(null,owner,"stateArea").value;
var clj_state_27251 = cljs.core.js__GT_clj.call(null,JSON.parse(state_27250),new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252),true);
cljs.core.reset_BANG_.call(null,ghoul.app.state.global,clj_state_27251);
...
if(typeof ghoul.app.components.popup.state.t27255 !== 'undefined'){
} else {

/**
* @constructor
*/
ghoul.app.components.popup.state.t27255 = (function (owner,data,root,meta27256){
this.owner = owner;
this.data = data;
this.root = root;
...
ghoul.app.components.popup.state.t27255.prototype.om$core$IRender$ = true;

ghoul.app.components.popup.state.t27255.prototype.om$core$IRender$render$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
...
ghoul.app.components.popup.state.t27255.prototype.om$core$IDidUpdate$ = true;

ghoul.app.components.popup.state.t27255.prototype.om$core$IDidUpdate$did_update$arity$3 = (function (this$,next_props,next_state){
var self__ = this;
var this$__$1 = this;
...
ghoul.app.components.popup.state.t27255.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_27257){
var self__ = this;
var _27257__$1 = this;
return self__.meta27256;
});

ghoul.app.components.popup.state.t27255.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_27257,meta27256__$1){
var self__ = this;
var _27257__$1 = this;
return (new ghoul.app.components.popup.state.t27255(self__.owner,self__.data,self__.root,meta27256__$1));
});

ghoul.app.components.popup.state.t27255.cljs$lang$type = true;

ghoul.app.components.popup.state.t27255.cljs$lang$ctorStr = "ghoul.app.components.popup.state/t27255";

ghoul.app.components.popup.state.t27255.cljs$lang$ctorPrWriter = (function (this__4190__auto__,writer__4191__auto__,opt__4192__auto__){
return cljs.core._write.call(null,writer__4191__auto__,"ghoul.app.components.popup.state/t27255");
});

ghoul.app.components.popup.state.__GT_t27255 = (function __GT_t27255(owner__$1,data__$1,root__$1,meta27256){
return (new ghoul.app.components.popup.state.t27255(owner__$1,data__$1,root__$1,meta27256));
});

}

return (new ghoul.app.components.popup.state.t27255(owner,data,root,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"end-column","end-column",1425389514),63,new cljs.core.Keyword(null,"end-line","end-line",1837326455),43,new cljs.core.Keyword(null,"column","column",2078222095),3,new cljs.core.Keyword(null,"line","line",212345235),25,new cljs.core.Keyword(null,"file","file",-1269645878),"/home/alotor/Projects/GhoulReader/ghoul-reader/src/cljs/app/ghoul/app/components/popup/state.cljs"], null)));
});

//# sourceMappingURL=state.js.map?rel=1420049677218